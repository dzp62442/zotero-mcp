...
"Content-Type" = "application/json"`;
    ...
    },
    {
      ...
      getInstructions: (port: number = 23120) => [
        ...
        "",
        "   With custom scope (user = all projects):",
        `   claude mcp add --transport http --scope user zotero-mcp http://127.0.0.1:${port}/mcp`,
        "",
        "▶ Method 2: JSON Configuration",
        "──────────────────────────────────────────────────────────",
        `   claude mcp add-json zotero-mcp '{"type":"http","url":"http://127.0.0.1:${port}/mcp"}'`,
        "",
        "▶ Management Commands",
        "──────────────────────────────────────────────────────────",
        "   List servers:    claude mcp list",
        "   Get details:     claude mcp get zotero-mcp",
        ...
        "   • get_item_details  - Get full item metadata",
        ...
        "   ✓ No restart required after adding server",
        "",
        "▶ Troubleshooting",
        "──────────────────────────────────────────────────────────",
        "   • Connection refused: Check if Zotero is running",
        "   • VPN/Proxy issues: Add 127.0.0.1 to bypass list",
        "   • Permission denied: Try --scope user",
        "   • Windows users: May need 'cmd /c' prefix for stdio",
        "",
        "══════════════════════════════════════════════════════════"
      ]
    },
